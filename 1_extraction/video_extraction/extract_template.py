...
# Seleciona frames aleatórios para processamento
    ...
    with Image.open(frame_filename) as img:
        ...
        for idx, bbox in enumerate(bboxes):
            if idx not in conflicting_indices:
                ...
                # Salva a região válida
                output_filename = os.path.join(output_dir, f'frame_{frame_number:04d}_region_{idx}.jpg')
